...
The current release is 2.17.3. See [VERSION.md](VERSION.md) for the version policy and [docs/releases](docs/releases/) for individual release notes. Codex sync installs Open Design skills only when you pass `-InstallOpenDesignSkills`.
