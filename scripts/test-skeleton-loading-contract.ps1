...
$required = @{
  ...
  'framework/53-skeleton-loading/09-shared-skeleton-api-and-registry.md' = @('public API', 'component registry', 'two real consumers', 'architecture or lint check')
  ...
  'framework/03-runtime/00-runtime-sequence.md' = @('Skeleton timing policy selected:', 'Delayed reveal verified:', 'Minimum visible duration verified:', 'SSR/hydration parity verified:', 'Shared skeleton API contract verified:', 'Cancellation and refresh behavior verified:')
