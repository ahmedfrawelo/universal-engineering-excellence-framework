...
try {
  New-Item -ItemType Directory -Path (Join-Path $fixture '.openai'), (Join-Path $fixture 'src'), (Join-Path $fixture 'scripts'), (Join-Path $fixture '.github\workflows'), (Join-Path $fixture 'packages\sample\node_modules'), (Join-Path $fixture 'packages\sample\dist') -Force | Out-Null
