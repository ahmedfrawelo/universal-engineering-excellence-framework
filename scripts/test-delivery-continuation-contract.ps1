...
$required = @{
  ...
  'framework/01-core/14-delivery-continuation-policy.md' = @('Internal implementation failures are never a real impasse', 'Repetition does not convert', 'no meaningful local implementation', 'BLOCKED_ALLOWED', 'repeated_external_condition', 'FINAL_ALLOWED', 'requested_outcome_complete', 'Stop When Done')
