...
$GeneratedSkipDirs = @(".ueef","vendor","engines","graphify-out","node_modules","dist","build","out","coverage",".next",".angular","bin","obj",".venv","graphifyy.egg-info","__pycache__",".pytest_cache",".hypothesis",".ruff_cache",".mypy_cache")
...
$generatedDirs = Find-DirsByName @("vendor","engines","graphify-out","dist","build","out","coverage",".next",".angular","node_modules","bin","obj","logs","screenshots","artifacts",".venv","graphifyy.egg-info","__pycache__",".pytest_cache",".hypothesis",".ruff_cache",".mypy_cache")
