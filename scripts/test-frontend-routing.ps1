...
if ($quality.modules -contains 'framework/60-spec-driven-development/00-spec-driven-development-system.md') { throw 'CSS bundle size collided with spec bundle routing.' }
...
if ($refactor.modules -match 'framework/61-project-modernization') { throw 'Focused refactor over-selected modernization.' }
