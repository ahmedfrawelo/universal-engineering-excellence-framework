...
export function newTurnState(sessionId, turnId, prompt, cwd, pickerModel = '') {
  ...
  authorizations.newUserTask = explicitlyPositive(/(?:\b(?:create|open|start|fork|handoff|move)\b.{0,50}\b(?:new\s+)?(?:task|thread|chat)\b|\bnew\s+(?:task|thread|chat)\b|(?:\u0627\u0641\u062a\u062d|\u0627\u0639\u0645\u0644|\u0627\u0646\u0634\u0626|\u0623\u0646\u0634\u0626|\u0633\u0644\u0645|\u062d\u0648\u0644|\u062d\u0648\u0651\u0644).{0,60}(?:(?:\u062a\u0627\u0633\u0643|\u0645\u0647\u0645\u0629|\u062b\u0631\u064a\u062f|\u0634\u0627\u062a).{0,20}(?:\u062c\u062f\u064a\u062f(?:\u0629|\u0647)?|\u062c\u064a\u062f)|(?:\u062c\u062f\u064a\u062f(?:\u0629|\u0647)?|\u062c\u064a\u062f).{0,20}(?:\u062a\u0627\u0633\u0643|\u0645\u0647\u0645\u0629|\u062b\u0631\u064a\u062f|\u0634\u0627\u062a)))/iu);
  return {
    schemaVersion: 1,
