...
Write-Utf8File $loader @(
  ...
  "1. Load UEEF Core System from $core.",
  "2. Load UEEF Master Loader from $master.",
  "3. Load UEEF Master Index from $index and $masterIndex.",
  ...
  "10. Include UEEF Verification in the final response.",
  "",
