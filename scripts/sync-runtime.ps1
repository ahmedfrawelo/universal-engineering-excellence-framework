...
$managedAgentsLines = @(
  ...
  "T4 requires scripts/validate-fresh-review-evidence.ps1 PASS before completion.",
  "Managed hooks enforce routing, protected paths, evidence, completion, progress, and goal closure. 100 percent means complete.",
  "",
  "Browser hard stop: Prefer the installed Chrome control plugin. Never launch Playwright, chrome-devtools, IDE Simple Browser, a second profile, or a new context; otherwise stop and ask.",
  "",
