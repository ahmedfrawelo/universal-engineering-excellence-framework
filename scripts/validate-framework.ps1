...
$requiredAcceptance = @(
  ...
  "framework/51-browser-session-control/11-autonomous-user-tab-control.md",
  "framework/51-browser-session-control/12-browser-control-runtime-health.md",
...
$browserTerms = @("User-owned browser selected:","Existing user tabs discovered automatically:","Target tab selected:","Active window identity verified:","Automation banner visible:","Connector-created window:","Connector tab matches user target:","Blank/wrong-tab recovery performed:","Browser evidence message verified:","Browser-control runtime health verified:","Visible signed-in state verified:","Isolated browser used:","Browser session gate:")
