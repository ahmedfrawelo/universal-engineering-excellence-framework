...
Current release: 2.24.0 (2026-08-02)
...
- Source validation and nested deterministic tests pass for 2.24.0.
- Codex, Cursor, generic, rollback, and staged-runtime installer tests include and validate the complete 2.24.0 payload.
