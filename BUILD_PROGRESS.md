...
Current release: 2.26.0 (2026-08-08)
...
- 2.26.0 adds a Spec Kit-derived workflow engine, persistent task graphs, resumable state, and dynamic conflict-safe execution waves.
...
- Source validation, nested deterministic tests, the full embedded repository-engine suite, and the Spec workflow engine suite pass for 2.26.0.
- Codex, Cursor, generic, rollback, and staged-runtime installer tests include and validate the complete 2.26.0 payload.
