...
Current release: 2.25.4 (2026-08-04)
...
- 2.25.4 adds managed Codex enforcement and native repository intelligence with attributed vendoring, cross-platform entrypoints, activation status, and runtime drift/source-revision proof.
...
- Source validation and nested deterministic tests pass for 2.25.4.
- Codex, Cursor, generic, rollback, and staged-runtime installer tests include and validate the complete 2.25.4 payload.
