...
Current release: 2.19.1 (2026-07-29)
...
- 2.19.1 adds a performance forensics workflow for evidence-first slow table, grid, API, SQL, cache, frontend render, and end-to-end bottleneck audits with report-only approval gates.
...
- Source validation and nested deterministic tests pass for 2.19.1.
