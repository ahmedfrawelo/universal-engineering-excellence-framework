...
5. For UI/UX work, select `Quick`, `Build`, or `Audit` through `framework/10-frontend/01-engineering/01-frontend-task-modes.md`; route design skills by their independent triggers instead of stacking a mandatory pair.
