...
Status: Stable  
Applies To: tasks where domain driven thinking materially affects the outcome

## Purpose

This module establishes the enforceable **domain driven thinking** contract for system boundaries, dependency direction, and architectural evolution. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names domain driven thinking or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the domain driven thinking decision explicit.

## Required Decisions

1. State the observable outcome and owner for domain driven thinking.
...
- Direct evidence that the domain driven thinking outcome works in the changed context.
...
- The domain driven thinking decision is implicit, ownerless, or contradicted by the implementation.
