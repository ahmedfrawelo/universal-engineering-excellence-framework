...
Status: Stable  
Applies To: tasks where technology neutral architecture materially affects the outcome

## Purpose

This module establishes the enforceable **technology neutral architecture** contract for system boundaries, dependency direction, and architectural evolution. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names technology neutral architecture or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the technology neutral architecture decision explicit.

## Required Decisions

1. State the observable outcome and owner for technology neutral architecture.
...
- Direct evidence that the technology neutral architecture outcome works in the changed context.
...
- The technology neutral architecture decision is implicit, ownerless, or contradicted by the implementation.
