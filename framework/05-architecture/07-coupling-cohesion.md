...
Status: Stable  
Applies To: tasks where coupling cohesion materially affects the outcome

## Purpose

This module establishes the enforceable **coupling cohesion** contract for system boundaries, dependency direction, and architectural evolution. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names coupling cohesion or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the coupling cohesion decision explicit.

## Required Decisions

1. State the observable outcome and owner for coupling cohesion.
...
- Direct evidence that the coupling cohesion outcome works in the changed context.
...
- The coupling cohesion decision is implicit, ownerless, or contradicted by the implementation.
