...
Pack: 00-foundation  
Status: Stable  
Applies To: tasks where quality philosophy materially affects the outcome

## Purpose

This module establishes the enforceable **quality philosophy** contract for the framework's governing values and non-negotiable priorities. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names quality philosophy or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the quality philosophy decision explicit.

## Required Decisions

1. State the observable outcome and owner for quality philosophy.
...
- Direct evidence that the quality philosophy outcome works in the changed context.
...
- The quality philosophy decision is implicit, ownerless, or contradicted by the implementation.
