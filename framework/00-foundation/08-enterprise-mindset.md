...
Pack: 00-foundation  
Status: Stable  
Applies To: tasks where enterprise mindset materially affects the outcome

## Purpose

This module establishes the enforceable **enterprise mindset** contract for the framework's governing values and non-negotiable priorities. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names enterprise mindset or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the enterprise mindset decision explicit.

## Required Decisions

1. State the observable outcome and owner for enterprise mindset.
...
- Direct evidence that the enterprise mindset outcome works in the changed context.
...
- The enterprise mindset decision is implicit, ownerless, or contradicted by the implementation.
