...
Pack: 00-foundation  
Status: Stable  
Applies To: tasks where universal rules materially affects the outcome

## Purpose

This module establishes the enforceable **universal rules** contract for the framework's governing values and non-negotiable priorities. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names universal rules or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the universal rules decision explicit.

## Required Decisions

1. State the observable outcome and owner for universal rules.
...
- Direct evidence that the universal rules outcome works in the changed context.
...
- The universal rules decision is implicit, ownerless, or contradicted by the implementation.
