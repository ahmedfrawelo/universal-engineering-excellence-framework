...
Provides repeatable review records for component and pattern changes.

## Required Practice

- Record existing search results and rejected alternatives.
- Document component contract, states, accessibility, themes, breakpoints, performance, and tests.
- Include adoption and migration plans when replacing a shared capability.
