# Duplicate and Design Drift Detection
...
Detects semantic duplication and visual or behavioral divergence early.

## Required Practice

- Search by behavior and user outcome, not component name alone.
- Audit raw values, near-identical components, copied validators, duplicate API clients, and conflicting overlay rules.
- Track drift findings with owner, impact, consolidation target, and deadline.
