...
Routes design-system and reuse work to the smallest relevant module.

## Required Practice

- Start with architecture and tokens, then select component, behavior, service, or governance modules.
- Use the reuse decision engine before adding a new component or service.
- Apply the pack quality gate and scorecard before completion.
