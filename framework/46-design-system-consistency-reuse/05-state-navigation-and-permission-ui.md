# State Navigation and Permission-Aware UI
...
Makes loading, empty, error, success, navigation, and entitlement behavior consistent.

## Required Practice

- Define reusable state surfaces with actionable recovery.
- Keep navigation location, back behavior, and deep links deterministic.
- Render permission-aware affordances from server-backed entitlements; never treat hidden UI as authorization.
