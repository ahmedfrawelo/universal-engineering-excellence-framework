# Dependency Decision Graph

## Decision Question

Which option satisfies the required **dependency** outcome while controlling necessity, ownership, license, vulnerabilities, maintenance, size, and replacement cost?

## Flow

1. Define the observable outcome, constraints, owner, and evidence threshold.
2. If the repository already has a conforming dependency mechanism, extend it and verify compatibility; otherwise continue.
3. List the viable options and reject any that cannot make failure, rollback, or ownership explicit.
4. Compare the remaining options on necessity, ownership, license, vulnerabilities, maintenance, size, and replacement cost.
...
- dependency audit, lockfile diff, compatibility checks, and removal or rollback plan.
