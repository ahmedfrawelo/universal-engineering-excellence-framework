...
9. create a current artifact from `framework/38-templates/32-frontend-execution-evidence-template.json` and validate it with `node scripts/validate-frontend-execution-evidence.mjs --path <artifact>`;
10. run `framework/27-quality-gates/35-frontend-design-production-gate.md` with the other selected gates;
