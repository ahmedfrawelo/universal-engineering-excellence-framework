...
Pack: 04-engineering  
Status: Stable  
Applies To: tasks where engineering discipline materially affects the outcome

## Purpose

This module establishes the enforceable **engineering discipline** contract for engineering judgment, tradeoffs, and sustainable delivery. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names engineering discipline or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the engineering discipline decision explicit.

## Required Decisions

1. State the observable outcome and owner for engineering discipline.
...
- Direct evidence that the engineering discipline outcome works in the changed context.
...
- The engineering discipline decision is implicit, ownerless, or contradicted by the implementation.
