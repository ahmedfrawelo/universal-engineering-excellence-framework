...
Start from `framework/38-templates/33-fresh-review-evidence-template.json`. Store task-local evidence under `.ueef/evidence/`; do not place it in a project root or confuse it with product output.
