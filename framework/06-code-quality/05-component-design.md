...
Status: Stable  
Applies To: tasks where component design materially affects the outcome

## Purpose

This module establishes the enforceable **component design** contract for code readability, change safety, and debt control. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names component design or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the component design decision explicit.

## Required Decisions

1. State the observable outcome and owner for component design.
...
- Direct evidence that the component design outcome works in the changed context.
...
- The component design decision is implicit, ownerless, or contradicted by the implementation.
