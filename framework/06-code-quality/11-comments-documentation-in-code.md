...
Status: Stable  
Applies To: tasks where comments documentation in code materially affects the outcome

## Purpose

This module establishes the enforceable **comments documentation in code** contract for code readability, change safety, and debt control. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names comments documentation in code or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the comments documentation in code decision explicit.

## Required Decisions

1. State the observable outcome and owner for comments documentation in code.
...
- Direct evidence that the comments documentation in code outcome works in the changed context.
...
- The comments documentation in code decision is implicit, ownerless, or contradicted by the implementation.
