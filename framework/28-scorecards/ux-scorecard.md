...
1. **Outcome fit** - the ux result satisfies the actual requirement.
2. **Domain completeness** - the work addresses user goal, task flow, comprehension, feedback, recovery, and effort.
...
5. **Evidence quality** - task-based review covering success, error, cancellation, and recovery is reproducible.
