...
1. **Outcome fit** - the code-quality result satisfies the actual requirement.
2. **Domain completeness** - the work addresses readability, responsibility, duplication, complexity, dependencies, and change safety.
...
5. **Evidence quality** - static checks, focused tests, and before-after complexity evidence is reproducible.
