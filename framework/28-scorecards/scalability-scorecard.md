...
1. **Outcome fit** - the scalability result satisfies the actual requirement.
2. **Domain completeness** - the work addresses capacity model, limiting resource, contention, partitioning, overload, and scale trigger.
...
5. **Evidence quality** - load tests at expected capacity and failure thresholds is reproducible.
