...
1. **Outcome fit** - the architecture result satisfies the actual requirement.
2. **Domain completeness** - the work addresses boundary ownership, dependency direction, coupling, deployment, and evolution cost.
...
5. **Evidence quality** - a dependency view, affected scenarios, and an ADR for the selected boundary is reproducible.
