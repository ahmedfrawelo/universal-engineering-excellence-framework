...
- If the browser-control platform changes the window state unexpectedly, stop further window-state actions and report the platform mutation. Do not issue another resize, focus, restore, maximize, minimize, move, or full-screen command unless the user explicitly requests it.
