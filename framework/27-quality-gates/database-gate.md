...
- The required database outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers data invariants, schema compatibility, locking, query plans, migration, and rollback.
- migration rehearsal, integrity queries, representative plans, and rollback evidence is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical database invariant, safety control, or acceptance behavior is missing or contradicted.
