...
- The required requirements outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers user outcome, constraints, acceptance behavior, ambiguity, exclusions, and traceability.
- requirements-to-test trace with resolved assumptions is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical requirements invariant, safety control, or acceptance behavior is missing or contradicted.
