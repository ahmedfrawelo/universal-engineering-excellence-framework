...
- The required testing outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers risk coverage, test level, determinism, fixtures, failure paths, and regression value.
- repeatable focused and integration results with flakes or skips reported is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical testing invariant, safety control, or acceptance behavior is missing or contradicted.
