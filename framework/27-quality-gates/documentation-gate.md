...
- The required documentation outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers audience, authority, accuracy, examples, discoverability, and update ownership.
- link and command checks plus comparison with current behavior is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical documentation invariant, safety control, or acceptance behavior is missing or contradicted.
