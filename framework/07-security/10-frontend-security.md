...
Pack: 07-security  
Status: Stable  
Applies To: tasks where frontend security materially affects the outcome

## Purpose

This module establishes the enforceable **frontend security** contract for application security, abuse resistance, and data protection. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names frontend security or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the frontend security decision explicit.

## Required Decisions

1. State the observable outcome and owner for frontend security.
...
- Direct evidence that the frontend security outcome works in the changed context.
...
- The frontend security decision is implicit, ownerless, or contradicted by the implementation.
