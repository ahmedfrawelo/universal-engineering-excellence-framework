...
Pack: 07-security  
Status: Stable  
Applies To: tasks where output protection materially affects the outcome

## Purpose

This module establishes the enforceable **output protection** contract for application security, abuse resistance, and data protection. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names output protection or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the output protection decision explicit.

## Required Decisions

1. State the observable outcome and owner for output protection.
...
- Direct evidence that the output protection outcome works in the changed context.
...
- The output protection decision is implicit, ownerless, or contradicted by the implementation.
