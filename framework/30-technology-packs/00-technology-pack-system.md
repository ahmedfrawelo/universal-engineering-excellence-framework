...
Version: 1.0  
Pack: 30-technology-packs  
Status: Stable  
Applies To: Engineering teams, AI coding assistants, and maintainers

## Purpose

Technology Packs provides the minimum enforceable operating guidance for this pack so the pack is not only a folder label. It defines how an assistant should reason, what it must protect, and what evidence should exist before completion.
