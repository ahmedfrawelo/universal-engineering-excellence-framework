...
1. **Outcome fit** - the ui result satisfies the actual requirement.
2. **Domain completeness** - the work addresses design-system reuse, semantics, state feedback, keyboard behavior, themes, and responsiveness.
...
5. **Evidence quality** - visual, keyboard, accessibility, and viewport evidence is reproducible.
