...
Version: 1.0
Pack: 12-delivery-quality/05-scorecards
Status: Stable
...
Use this module when the task touches scorecards concerns, when repository inspection finds related files, or when a design decision could affect maintainability, security, performance, scalability, user experience, or production readiness.
