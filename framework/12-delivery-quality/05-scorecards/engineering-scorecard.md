...
1. **Outcome fit** - the engineering result satisfies the actual requirement.
2. **Domain completeness** - the work addresses requirement fit, design clarity, maintainability, risk, evidence, and operability.
...
5. **Evidence quality** - cross-discipline review evidence tied to the implementation is reproducible.
