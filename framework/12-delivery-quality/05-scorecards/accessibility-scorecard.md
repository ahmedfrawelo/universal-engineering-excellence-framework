...
1. **Outcome fit** - the accessibility result satisfies the actual requirement.
2. **Domain completeness** - the work addresses semantics, keyboard flow, focus, naming, contrast, zoom, and assistive technology.
...
5. **Evidence quality** - automated scans plus keyboard and screen-reader-oriented manual evidence is reproducible.
