...
1. **Outcome fit** - the maintainability result satisfies the actual requirement.
2. **Domain completeness** - the work addresses change locality, readability, coupling, testability, ownership, and debt.
...
5. **Evidence quality** - a concrete future-change walkthrough plus complexity and test evidence is reproducible.
