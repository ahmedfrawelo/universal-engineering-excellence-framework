...
Protects governed visual language, tokens, components, patterns, themes, and interactions.

## Guardian Rules

- Run registry and token searches before adding UI.
- Check mixed icon, type, spacing, border, radius, shadow, motion, and loading languages.
- Use pack 48 and pack 47 evidence for visual and behavior changes.
