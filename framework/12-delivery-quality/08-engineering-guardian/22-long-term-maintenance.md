...
- Document ownership, lifecycle, dependencies, migration, observability, and recovery.
- Prefer boring, explicit behavior over clever coupling.
- Review deprecation and upgrade paths before release.
