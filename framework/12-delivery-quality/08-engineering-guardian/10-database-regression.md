...
Protects correctness, query performance, migrations, availability, and data boundaries.

## Guardian Rules

- Review execution plans, indexes, transactions, locks, cardinality, and growth impact.
- Test migrations forward and backward or document irreversible change.
- Verify tenant and authorization predicates remain enforced.
