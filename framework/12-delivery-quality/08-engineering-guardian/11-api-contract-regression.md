...
Prevents incompatible request, response, error, authorization, and performance changes.

## Guardian Rules

- Use contract tests and versioning for public or shared APIs.
- Preserve safe error shapes, idempotency, pagination, and timeout behavior.
- Check generated clients, consumers, documentation, and telemetry.
