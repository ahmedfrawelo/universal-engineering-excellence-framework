...
Checks whether a change preserves safe evolution, extensibility, portability, and operational learning.

## Guardian Rules

- Identify likely change axes and keep them behind stable contracts.
- Avoid speculative abstractions and irreversible choices without evidence.
- Record assumptions that future evidence should revisit.
