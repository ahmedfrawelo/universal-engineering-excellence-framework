...
Prevents a task from reducing quality in any affected engineering dimension.

## Guardian Rules

- Compare before and after behavior, not only source diff.
- Stop, fix, and re-run checks when a regression appears.
- Require explicit owner, impact, expiry, and rollback for accepted residual risk.
