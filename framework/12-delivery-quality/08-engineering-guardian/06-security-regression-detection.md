...
Prevents changes that weaken identity, authorization, secrets, validation, isolation, or abuse controls.

## Guardian Rules

- Re-run affected security tests and authorization matrices.
- Treat unresolved High and Critical findings as release blockers.
- Check logs, audit trails, error redaction, and dependency changes.
