...
Protects naming, typing, error handling, validation, logging, tests, and implementation conventions.

## Guardian Rules

- Follow local conventions and shared helpers.
- Remove dead code, unused imports, duplicated logic, and inconsistent error paths nearby.
- Use lint, typecheck, format, and review rules as evidence.
