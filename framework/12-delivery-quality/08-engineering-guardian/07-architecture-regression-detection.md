...
Protects boundaries, dependency direction, cohesion, modularity, and operational ownership.

## Guardian Rules

- Compare dependency direction and boundary ownership before and after.
- Reject shortcuts that create hidden coupling or bypass domain policies.
- Update ADRs and migration paths when architecture changes.
