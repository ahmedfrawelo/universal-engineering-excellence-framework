...
Controls security, license, size, behavior, and maintenance risk from dependency changes.

## Guardian Rules

- Check advisories, license policy, transitive changes, bundle impact, and support status.
- Prefer existing dependencies and platform capabilities.
- Record removal, upgrade, pinning, and rollback rationale.
