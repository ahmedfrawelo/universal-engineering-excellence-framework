...
Prevents random files, ownership ambiguity, and architecture drift in repository structure.

## Guardian Rules

- Place new files under an existing owned boundary.
- Use established naming and module structure.
- Document intentional new folders and update indexes or manifests.
