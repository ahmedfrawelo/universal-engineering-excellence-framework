...
Finds user-facing and operational regressions before and after release.

## Guardian Rules

- Use health checks, error rates, latency, support signals, and synthetic workflows.
- Define rollback or mitigation triggers before deployment.
- Link incidents to corrective actions and regression tests.
