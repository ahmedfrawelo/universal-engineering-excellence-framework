...
Scores health without allowing averages to hide critical risk.

## Guardian Rules

- Score architecture, security, performance, scalability, maintainability, UI, UX, accessibility, reliability, documentation, tests, and developer experience.
- Track trend and evidence, not a single subjective number.
- Cap the score at fail when critical blockers remain.
