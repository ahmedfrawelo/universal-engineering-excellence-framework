...
Forces the assistant to challenge assumptions and search for missed regressions before claiming completion.

## Guardian Rules

- Ask what became worse, what evidence is missing, and which user or operator path was not tested.
- Compare at least one alternative when risk is non-trivial.
- Turn discovered weakness into a fix, test, documented limitation, or blocker.
