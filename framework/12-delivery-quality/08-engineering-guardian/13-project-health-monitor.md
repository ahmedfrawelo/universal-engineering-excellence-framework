...
Summarizes maintainability, delivery, reliability, quality, security, performance, and team friction.

## Guardian Rules

- Track leading and lagging indicators with trend, threshold, and owner.
- Use health signals to prioritize improvements rather than create vanity metrics.
- Review health after major releases and incidents.
