...
Prevents accidental growth in cognitive, cyclomatic, dependency, data, and operational complexity.

## Guardian Rules

- Measure complexity where it affects change cost or failure risk.
- Prefer deletion, simplification, and clear boundaries before abstractions.
- Set thresholds and exceptions for generated or inherently complex code.
