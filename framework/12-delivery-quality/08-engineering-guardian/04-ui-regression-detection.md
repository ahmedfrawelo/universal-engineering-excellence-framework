...
Protects visual hierarchy, interaction, theme, responsive, accessibility, and content behavior.

## Guardian Rules

- Compare representative routes and states in supported themes and viewports.
- Check shared components before accepting a page-specific workaround.
- Use visual or interaction regression evidence for high-risk surfaces.
