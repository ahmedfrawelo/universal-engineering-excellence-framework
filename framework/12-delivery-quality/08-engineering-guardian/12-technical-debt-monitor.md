...
Makes debt visible, owned, measurable, and prevented from silently compounding.

## Guardian Rules

- Record debt origin, impact, interest, owner, target, and expiry.
- Pay down nearby obvious debt when scope and risk remain controlled.
- Do not classify recurring quality failures as harmless debt.
