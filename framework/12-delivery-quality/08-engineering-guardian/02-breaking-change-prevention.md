...
Controls public API, schema, configuration, UI, runtime, and workflow changes.

## Guardian Rules

- Identify consumers and compatibility obligations before changing a contract.
- Prefer additive evolution, deprecation, migration, and compatibility tests.
- Classify and communicate unavoidable breaks before release.
