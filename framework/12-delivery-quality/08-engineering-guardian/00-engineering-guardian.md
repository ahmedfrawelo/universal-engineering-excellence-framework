...
Establishes a permanent quality guardian that protects architecture, security, performance, scalability, maintainability, UI, UX, accessibility, reliability, documentation, testing, and developer experience.

## Guardian Rules

- Inspect before editing and define the affected baseline.
- Select all applicable guardian monitors and quality gates.
- Leave the affected area equal or better, or record an approved exception.
...
- framework/13-ai/04-review
- framework/12-delivery-quality/04-quality-gates
- framework/12-delivery-quality/05-scorecards
- framework/16-design-system/03-governance
- framework/16-design-system/02-theme-responsive-interaction-security-performance
