...
Reviews whether the result feels coherent, useful, accessible, reliable, secure, fast, and maintainable as one premium product.

## Guardian Rules

- Review user outcome, clarity, hierarchy, feedback, recovery, responsiveness, and accessibility.
- Review architecture, security, performance, observability, testing, documentation, and ownership.
- Use direct evidence instead of brand-name comparison as proof.
