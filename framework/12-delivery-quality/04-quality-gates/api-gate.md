...
- The required api outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers compatibility, authorization, idempotency, validation, and error contracts.
- contract tests for success, invalid input, forbidden access, retries, and prior clients is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical api invariant, safety control, or acceptance behavior is missing or contradicted.
