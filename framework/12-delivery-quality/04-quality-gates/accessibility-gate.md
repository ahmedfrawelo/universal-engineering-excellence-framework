...
- The required accessibility outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers semantics, keyboard flow, focus, naming, contrast, zoom, and assistive technology.
- automated scans plus keyboard and screen-reader-oriented manual evidence is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical accessibility invariant, safety control, or acceptance behavior is missing or contradicted.
