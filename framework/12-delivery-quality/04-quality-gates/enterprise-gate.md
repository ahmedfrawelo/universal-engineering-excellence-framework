...
- The required enterprise outcome and acceptance boundary are explicit.
- The implementation conforms to repository ownership and conventions.
- Review covers ownership, tenancy, policy, audit, retention, support, and regulatory controls.
- control-to-evidence mapping and named operational ownership is current, reproducible, and successful.
- Residual risk has a named owner, mitigation, and trigger.

## Hard Failures

- A critical enterprise invariant, safety control, or acceptance behavior is missing or contradicted.
