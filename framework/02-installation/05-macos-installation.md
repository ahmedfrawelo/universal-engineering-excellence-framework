...
Status: Stable  
Applies To: tasks where macos installation materially affects the outcome

## Purpose

This module establishes the enforceable **macos installation** contract for installation lifecycle, platform integration, and recovery. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names macos installation or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the macos installation decision explicit.

## Required Decisions

1. State the observable outcome and owner for macos installation.
...
- Direct evidence that the macos installation outcome works in the changed context.
...
- The macos installation decision is implicit, ownerless, or contradicted by the implementation.
