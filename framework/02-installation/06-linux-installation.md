...
Status: Stable  
Applies To: tasks where linux installation materially affects the outcome

## Purpose

This module establishes the enforceable **linux installation** contract for installation lifecycle, platform integration, and recovery. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names linux installation or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the linux installation decision explicit.

## Required Decisions

1. State the observable outcome and owner for linux installation.
...
- Direct evidence that the linux installation outcome works in the changed context.
...
- The linux installation decision is implicit, ownerless, or contradicted by the implementation.
