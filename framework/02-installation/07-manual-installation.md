...
Status: Stable  
Applies To: tasks where manual installation materially affects the outcome

## Purpose

This module establishes the enforceable **manual installation** contract for installation lifecycle, platform integration, and recovery. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names manual installation or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the manual installation decision explicit.

## Required Decisions

1. State the observable outcome and owner for manual installation.
...
- Direct evidence that the manual installation outcome works in the changed context.
...
- The manual installation decision is implicit, ownerless, or contradicted by the implementation.
