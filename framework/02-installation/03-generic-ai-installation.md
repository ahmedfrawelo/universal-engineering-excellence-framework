# generic ai installation

Version: 1.0  
Pack: 02-installation  
Status: Stable  
Applies To: tasks where generic ai installation materially affects the outcome

## Purpose

This module establishes the enforceable **generic ai installation** contract for installation lifecycle, platform integration, and recovery. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names generic ai installation or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the generic ai installation decision explicit.

## Required Decisions

1. State the observable outcome and owner for generic ai installation.
...
- Direct evidence that the generic ai installation outcome works in the changed context.
...
- The generic ai installation decision is implicit, ownerless, or contradicted by the implementation.
