...
- For Arabic or other RTL prose with embedded English, trust the renderer for ordinary mixed-language text. Reserve inline code for real identifiers or commands and never wrap a full sentence or status block in inline code. Do not use hidden direction characters inside code blocks, terminal commands, copyable file paths, JSON/YAML, source files, configuration, or saved artifacts.
...
UEEF: ACTIVE
Loaded: boot-loader, core-system
Selected: framework/10-frontend/01-engineering/00-frontend-engineering.md, framework/10-frontend/03-ui/00-ui-system.md
