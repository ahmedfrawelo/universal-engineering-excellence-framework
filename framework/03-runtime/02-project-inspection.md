...
Pack: 03-runtime  
Status: Stable  
Applies To: tasks where project inspection materially affects the outcome

## Purpose

This module establishes the enforceable **project inspection** contract for the request-to-delivery execution lifecycle. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names project inspection or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the project inspection decision explicit.

## Required Decisions

1. State the observable outcome and owner for project inspection.
...
- Direct evidence that the project inspection outcome works in the changed context.
...
- The project inspection decision is implicit, ownerless, or contradicted by the implementation.
