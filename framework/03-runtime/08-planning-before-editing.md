...
Pack: 03-runtime  
Status: Stable  
Applies To: tasks where planning before editing materially affects the outcome

## Purpose

This module establishes the enforceable **planning before editing** contract for the request-to-delivery execution lifecycle. It exists to turn that concern into explicit decisions, safeguards, and completion evidence.

## Apply When

- The request names planning before editing or changes behavior governed by it.
- Repository inspection finds an affected boundary, convention, artifact, or risk.
- A reviewer cannot prove the outcome without making the planning before editing decision explicit.

## Required Decisions

1. State the observable outcome and owner for planning before editing.
...
- Direct evidence that the planning before editing outcome works in the changed context.
...
- The planning before editing decision is implicit, ownerless, or contradicted by the implementation.
