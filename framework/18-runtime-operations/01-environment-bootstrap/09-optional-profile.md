...
Tracks image generation, Storybook, profilers, benchmarking, and monitoring.

## Required Practice

- Report availability and suggest only when useful.
- Optional gaps never block engineering.
