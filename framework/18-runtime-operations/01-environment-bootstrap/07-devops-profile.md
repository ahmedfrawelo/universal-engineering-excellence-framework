...
Checks Docker, GitHub CLI, build, deployment, and infrastructure tools only for DevOps work.

## Required Practice

- Detect CI, container, cloud, deployment, and infrastructure signals.
- Detection does not deploy or mutate infrastructure.
