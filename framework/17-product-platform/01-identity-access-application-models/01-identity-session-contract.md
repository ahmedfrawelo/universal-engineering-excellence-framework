...
Defines authentication assurance, session lifecycle, renewal, revocation, recovery, and device behavior.

## Required Practice

- Use standards-based identity providers and secure cookie or token handling.
- Set explicit idle, absolute, renewal, and revocation rules by risk.
- Keep sign-in, expiry, recovery, and step-up states accessible and responsive.
