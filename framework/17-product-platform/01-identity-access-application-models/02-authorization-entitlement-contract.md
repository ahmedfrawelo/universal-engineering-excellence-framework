...
Separates identity, role, permission, ownership, subscription, and feature entitlement decisions.

## Required Practice

- Authorize every action and object on the server.
- Centralize policies and test allow and deny matrices.
- Return safe capability metadata for UI affordances without exposing policy internals.
