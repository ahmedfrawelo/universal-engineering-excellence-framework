...
Covers organizations, membership, invitations, subscriptions, entitlements, tenant administration, and auditability.

## Required Practice

- Separate platform administration from tenant administration.
- Make plan and feature entitlements server-authoritative.
- Use idempotency and audit events for billing, invitations, role changes, and destructive actions.
