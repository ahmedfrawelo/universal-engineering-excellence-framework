...
Aligns capability presentation, denial recovery, and security audit events.

## Required Practice

- Hide or disable unavailable actions according to product need while the server still denies unauthorized requests.
- Explain recoverable access states such as request access, upgrade, or switch organization.
- Audit sensitive allow and deny decisions with actor, tenant, action, resource, result, and correlation ID.
...
- `framework/16-design-system/02-theme-responsive-interaction-security-performance/39-database-and-tenant-security-hardening.md`
