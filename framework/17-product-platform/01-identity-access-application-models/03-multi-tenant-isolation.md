...
Defines tenant context propagation and isolation across APIs, databases, caches, jobs, files, search, and telemetry.

## Required Practice

- Derive tenant context from trusted identity and validate resource ownership.
- Include tenant keys in queries, cache keys, uniqueness, exports, and asynchronous messages.
- Run cross-tenant negative tests for reads, writes, enumeration, and administrative paths.
