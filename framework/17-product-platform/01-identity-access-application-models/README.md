# Identity Access and Application Models
...
Defines identity, authorization, entitlement, tenant, and audience rules for SaaS, employee, public, and hybrid products.

## Required Practice

- Select an application model before designing identity and access behavior.
- Enforce authorization and tenant boundaries on trusted backend paths.
- Keep UI capability visibility synchronized with, but never a replacement for, server policy.
