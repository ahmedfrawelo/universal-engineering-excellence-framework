...
Checks database CLIs, migration tools, drivers, and authorized connectivity.

## Required Practice

- Detect schema, migration, ORM, and provider signals; never print secrets.
- Missing required database tooling blocks the database task.
