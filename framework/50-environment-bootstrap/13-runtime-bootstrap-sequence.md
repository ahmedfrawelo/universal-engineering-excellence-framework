...
Defines the order and readiness output for environment bootstrap.

## Required Practice

- Select profiles, verify dependencies, repair mandatory gaps, then emit concise Environment Profile output.
- Do not continue after BLOCKED; rerun after installs or task-scope changes.
