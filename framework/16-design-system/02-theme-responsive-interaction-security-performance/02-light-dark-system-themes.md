...
Requires coordinated light, dark, and system modes for new frontend products.

## Required Practice

- Design light and dark surfaces together; never derive dark mode by inversion.
- Resolve system mode through the platform preference and define live-change behavior.
- Test every shared state and data visualization in both resolved themes.
