...
Uses tokenized motion to communicate state without slowing work.

## Required Practice

- Use 150 to 300ms for most micro-interactions and make exit faster than entry.
- Animate transform and opacity where possible to avoid layout work.
- Make motion interruptible and preserve immediate input response.
