...
Makes tokens the controlled interface between design decisions and implementation.

## Required Practice

- Use semantic aliases for color, type, spacing, radius, shadow, motion, layers, and component dimensions.
- Enforce token use with linting, review checks, or typed APIs.
- Deprecate tokens through aliases and migrations rather than silent value changes.
