# Escape Focus and Keyboard Behavior
...
Defines deterministic keyboard dismissal and focus movement.

## Required Practice

- Escape closes only the topmost dismissible overlay.
- Return focus to the invoking trigger or a documented logical successor.
- Keep Tab inside modal surfaces and allow normal document traversal for non-modal surfaces.
