...
Adapts non-essential motion to user preferences without removing necessary state feedback.

## Required Practice

- Respect prefers-reduced-motion and platform equivalents.
- Replace spatial movement with short fades or immediate state changes.
- Keep progress and status understandable without animation.
