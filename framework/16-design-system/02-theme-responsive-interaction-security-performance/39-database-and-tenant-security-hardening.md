# Database and Tenant Security Hardening
...
Protects data boundaries, tenant isolation, privileges, and query construction.

## Required Practice

- Propagate trusted tenant context and include it in every tenant-owned query and uniqueness rule.
- Use parameterized queries, least-privilege identities, encryption, and audited administrative paths.
- Test cross-tenant reads, writes, exports, caches, jobs, and object storage references.
...
- `framework/16-design-system/01-consistency-reuse/README.md`
