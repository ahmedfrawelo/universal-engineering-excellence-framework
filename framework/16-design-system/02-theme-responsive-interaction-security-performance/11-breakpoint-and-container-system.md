# Breakpoint and Container System
...
Uses content-driven breakpoints and stable container rules.

## Required Practice

- Centralize named viewport and container breakpoints.
- Prefer container queries for reusable components whose behavior depends on available space.
- Test immediately below and above every behavior-changing threshold.
