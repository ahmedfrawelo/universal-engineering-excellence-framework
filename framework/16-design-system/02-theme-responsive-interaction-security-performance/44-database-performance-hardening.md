...
Optimizes query shape, indexes, transactions, concurrency, and data growth with evidence.

## Required Practice

- Inspect execution plans and logical reads for important queries.
- Index for measured access paths while accounting for write cost.
- Keep transactions short, pagination bounded, and statistics and maintenance observable.
