...
Defines role-based colors for surfaces, content, actions, status, navigation, data, borders, focus, scrims, and shadows.

## Required Practice

- Map each semantic role independently for light and dark themes.
- Verify foreground and background pairs against WCAG contrast.
- Never rely on color alone for status or selection.
