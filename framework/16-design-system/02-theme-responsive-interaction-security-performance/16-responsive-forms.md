...
Keeps forms legible, touchable, and recoverable on all supported viewports.

## Required Practice

- Use visible labels, semantic input types, and 44px minimum targets.
- Collapse columns by meaning and preserve logical reading order.
- Keep validation near fields and focus the first invalid field after submission.
