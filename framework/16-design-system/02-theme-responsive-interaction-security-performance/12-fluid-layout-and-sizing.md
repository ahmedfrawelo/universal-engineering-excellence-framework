...
Creates layouts that interpolate safely between supported extremes.

## Required Practice

- Use grid, flex, minmax, clamp, aspect-ratio, and logical properties.
- Set min-width: 0 on shrinkable tracks and prevent accidental horizontal overflow.
- Use dynamic viewport units and safe-area insets for mobile chrome.
