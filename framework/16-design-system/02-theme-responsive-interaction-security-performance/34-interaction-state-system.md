...
Defines consistent default, hover, focus, active, selected, disabled, loading, success, warning, and error states.

## Required Practice

- Map states to semantic tokens and native semantics.
- Keep state changes stable without layout shifts.
- Verify state parity in light, dark, high contrast, touch, and keyboard modes.
