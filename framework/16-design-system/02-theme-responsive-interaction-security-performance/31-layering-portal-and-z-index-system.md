# Layering Portal and Z-Index System
...
Controls stacking through semantic layers and intentional portal roots.

## Required Practice

- Define tokens for base, sticky, navigation, dropdown, popover, drawer, modal, toast, and emergency layers.
- Resolve stacking contexts before increasing z-index.
- Keep portals inside the correct theme, direction, and application ownership context.
