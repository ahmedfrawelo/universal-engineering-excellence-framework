...
Optimizes measured user and system outcomes across rendering, compute, data, and network paths.

## Required Practice

- Define budgets before optimization and measure representative workloads.
- Remove duplicated work and algorithmic waste before micro-optimizing.
- Protect latency, throughput, memory, cost, and reliability with regression gates.
