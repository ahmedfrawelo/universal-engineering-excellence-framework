# Loading Submission and Double Click Prevention
...
Prevents duplicate work while keeping asynchronous status visible and recoverable.

## Required Practice

- Disable or lock the initiating control after accepted submission and show progress promptly.
- Use server idempotency for sensitive or retryable commands.
- Distinguish queued, processing, succeeded, failed, and retry-safe states.
