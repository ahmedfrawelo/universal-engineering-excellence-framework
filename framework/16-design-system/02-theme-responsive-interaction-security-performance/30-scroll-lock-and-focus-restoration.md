...
Prevents background drift while preserving scroll position and input context.

## Required Practice

- Lock document scroll only for modal surfaces and compensate for scrollbar width.
- Avoid body position hacks that jump mobile pages unless tested across supported browsers.
- Restore scroll and focus once after the final modal lock is released.
