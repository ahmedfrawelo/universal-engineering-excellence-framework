...
Dismisses eligible overlays without races, accidental reopen, or loss of user work.

## Required Practice

- Evaluate pointer events against trigger and overlay boundaries.
- Treat trigger activation separately so the same event cannot close then reopen the overlay.
- Do not dismiss modals or dirty forms when their contract requires confirmation.
