...
Scores product-system quality without allowing averages to hide critical failures.

## Required Practice

- Score each category from zero to four with linked evidence.
- Cap the overall result at fail when accessibility, authorization, tenant isolation, or critical performance budgets fail.
- Track score trends and remediation owners across releases.
