# Network Asset and Bundle Performance
...
Reduces bytes, round trips, connection contention, and cache misses.

## Required Practice

- Compress text, optimize images and fonts, and serve stable content with immutable caching.
- Budget initial and route-level JavaScript and remove unused dependencies.
- Use preconnect, preload, prefetch, and service workers only when measurements justify them.
