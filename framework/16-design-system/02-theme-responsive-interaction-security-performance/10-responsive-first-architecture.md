...
Makes responsive behavior part of component and page contracts from the first implementation.

## Required Practice

- Start with content priority and smallest supported viewport.
- Define adaptation rules for width, height, orientation, input, zoom, and text scaling.
- Reject desktop-only implementation followed by emergency mobile overrides.
