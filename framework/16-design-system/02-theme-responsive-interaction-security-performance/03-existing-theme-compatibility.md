...
Preserves the identity and conventions of an existing product.

## Required Practice

- Inspect variables, tokens, palette, typography, spacing, radius, shadows, components, modes, brand, layout, motion, breakpoints, and overlays.
- Extend valid existing abstractions before replacing them.
- Document any replacement with migration risk and visual comparison evidence.
