# Responsive Images Media and Icons
...
Delivers inspectable media efficiently without distortion or layout shift.

## Required Practice

- Provide intrinsic dimensions, aspect ratio, responsive sources, and meaningful alternatives.
- Use vector icons from one consistent set and semantic size tokens.
- Lazy-load non-critical media and never lazy-load the primary visible subject.
