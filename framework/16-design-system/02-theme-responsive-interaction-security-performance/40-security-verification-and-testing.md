...
Requires evidence from automated checks and adversarial scenarios.

## Required Practice

- Run dependency, secret, static, configuration, and dynamic checks appropriate to the stack.
- Test authorization matrices, tenant isolation, input boundaries, abuse controls, and failure redaction.
- Record tool versions, scope, findings, owners, and accepted residual risk.
