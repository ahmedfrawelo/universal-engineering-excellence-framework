...
Centralizes theme selection, semantic token resolution, application, and extension.

## Required Practice

- Separate user preference from resolved theme.
- Expose one typed theme contract consumed by the application shell and component system.
- Keep feature code independent of raw palette values.
