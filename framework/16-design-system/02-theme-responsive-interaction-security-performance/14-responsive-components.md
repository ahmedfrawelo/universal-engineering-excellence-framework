...
Defines component-owned adaptation without leaking page assumptions.

## Required Practice

- Specify minimum viable width, wrapping, collapse, overflow, and alternate composition.
- Keep controls operable at 200 percent zoom and with long localized labels.
- Use shared variants instead of page-specific media-query forks.
