# Theme Responsive Interaction Security and Performance Review Checklist
...
Provides a final, evidence-backed review across the full pack.

## Required Practice

- Verify existing-system compatibility before new architecture.
- Exercise themes, breakpoints, input modes, overlay paths, trust boundaries, and load scenarios.
- Record commands, screenshots, traces, reports, and residual limitations.
