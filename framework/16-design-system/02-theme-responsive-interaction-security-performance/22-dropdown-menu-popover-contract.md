# Dropdown Menu and Popover Contract
...
Separates selection, command, and explanatory overlays while sharing reliable mechanics.

## Required Practice

- Use listbox for selection, menu for commands, and popover for non-modal content.
- Support arrow navigation, Home, End, typeahead where expected, and Escape.
- Anchor to the trigger, handle collision, and expose expanded and controls relationships.
