...
Treats the client as untrusted while reducing browser attack surface.

## Required Practice

- Avoid unsafe HTML, script construction, exposed secrets, and security decisions based only on UI state.
- Use CSP, trusted origins, secure cookies, CSRF defenses, and dependency review as applicable.
- Redact telemetry and prevent sensitive data from persistent browser storage.
