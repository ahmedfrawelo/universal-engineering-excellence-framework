...
Preserves readable hierarchy under narrow widths, zoom, localization, and user text scaling.

## Required Practice

- Use tokenized roles and bounded fluid sizing only where hierarchy benefits.
- Keep body text at least 16px on mobile inputs and control readable line length.
- Wrap first; truncate only with an accessible disclosure path.
