...
Defines side panels as purposeful task regions with predictable dismissal and responsive behavior.

## Required Practice

- Specify modal versus non-modal behavior and whether background interaction remains available.
- Trap focus only for modal drawers and restore it on close.
- Preserve unsaved work through confirmation or draft recovery.
