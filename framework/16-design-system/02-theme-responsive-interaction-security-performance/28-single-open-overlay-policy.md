...
Coordinates peer overlays so conflicting transient surfaces do not remain open.

## Required Practice

- Register transient overlays by scope and conflict group.
- Opening a peer closes the active peer before focus enters the new surface.
- Allow multiple surfaces only when they are intentionally nested or non-conflicting.
