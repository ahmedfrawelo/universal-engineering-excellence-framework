...
Preserves data meaning and task efficiency across screen sizes.

## Required Practice

- Choose scrolling, column priority, stacked rows, cards, or detail disclosure based on comparison needs.
- Keep headers associated with cells and controls keyboard reachable.
- Paginate or virtualize large data and preserve filter access on mobile.
