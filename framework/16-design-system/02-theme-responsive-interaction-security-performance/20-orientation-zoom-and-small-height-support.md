# Orientation Zoom and Small Height Support
...
Protects workflows under landscape, browser zoom, text zoom, and short viewports.

## Required Practice

- Test 320 CSS pixel width, 200 percent zoom, landscape phones, and 600 CSS pixel height.
- Keep primary actions reachable without fixed elements covering content.
- Never disable browser zoom or lock orientation without a product-critical reason.
