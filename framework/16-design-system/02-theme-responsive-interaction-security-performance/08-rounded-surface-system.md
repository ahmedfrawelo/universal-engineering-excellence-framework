...
Uses a controlled soft-corner scale without making every surface pill-shaped.

## Required Practice

- Define none, small, medium, large, extra-large, and full radius tokens.
- Assign radii by component role and nesting depth.
- Use full radius only for tags, badges, avatars, or semantically pill-shaped controls.
