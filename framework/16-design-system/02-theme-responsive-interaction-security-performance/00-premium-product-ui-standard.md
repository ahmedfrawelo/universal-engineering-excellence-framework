...
Defines professional product quality as clarity, consistency, accessibility, restraint, and measured behavior.

## Required Practice

- Match the product domain and existing visual language before adding novelty.
- Use clear hierarchy, stable layout, concise copy, and complete interactive states.
- Treat visible defects and confusing workflows as release blockers.
