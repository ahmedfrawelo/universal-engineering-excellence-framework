...
Keeps content, focus, state, charts, images, and controls perceivable in every theme.

## Required Practice

- Meet 4.5:1 normal text and 3:1 large text and UI component contrast.
- Support forced-colors and user contrast preferences where applicable.
- Verify focus, disabled, selected, danger, and chart states separately per theme.
