...
Applies the correct theme early and persists only minimal preference data.

## Required Practice

- Use precedence: explicit choice, authenticated preference, local preference, system preference, application default.
- Apply resolved theme before first paint where practical to prevent incorrect-theme flash.
- Synchronize tabs when the product requires immediate consistency.
