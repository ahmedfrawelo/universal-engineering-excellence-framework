...
Maps surfaces, overlays, navigation, and transient feedback to a stable depth model.

## Required Practice

- Define elevation by semantic layer and interaction purpose.
- Coordinate elevation with scrims, borders, portals, and z-index tokens.
- Keep elevation distinguishable in light and dark themes without relying on blur alone.
