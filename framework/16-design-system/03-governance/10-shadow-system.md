...
Centralizes elevation cues and theme-aware shadow behavior.

## Required Practice

- Define xs, sm, md, lg, and xl shadows with semantic use cases.
- Use surface hierarchy and borders when shadows are ineffective in dark or high-contrast modes.
- Do not add decorative shadow values per page.
