...
Unifies containers, grids, regions, density, and responsive composition.

## Required Practice

- Define named containers, gutters, columns, gaps, and safe-area behavior.
- Use content priority to determine collapse and reflow rules.
- Avoid wrapping every section in a card or creating page-specific layout primitives.
