...
Controls light, dark, system, persistence, tokens, and theme compatibility.

## Required Practice

- Inspect and extend an existing theme before changing it.
- Require semantic tokens and coordinated state coverage in every supported theme.
- Test initialization, system changes, persistence, contrast, charts, overlays, and brand assets.
