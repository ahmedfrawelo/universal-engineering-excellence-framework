...
Ensures one coherent icon family and accessible icon behavior.

## Required Practice

- Choose one primary icon family for the product and record the choice.
- Tokenize size, stroke, weight, alignment, and color.
- Provide accessible names for meaningful icons and never use emoji as structural controls.
