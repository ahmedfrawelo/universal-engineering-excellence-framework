...
Makes responsive quality a design-system responsibility, not a late page patch.

## Required Practice

- Define breakpoints or container queries from content behavior.
- Cover mobile, tablet, laptop, desktop, large screens, orientation, zoom, text scaling, touch, mouse, and keyboard.
- Keep one component behavior source and avoid duplicate desktop/mobile markup without a documented reason.
