...
Creates one shared vocabulary for visual hierarchy, interaction feedback, content density, and product tone.

## Required Practice

- Name design decisions by role and user outcome, not by one screen or implementation detail.
- Document hierarchy, density, emphasis, and state behavior before adding variants.
- Keep language consistent across navigation, forms, tables, cards, overlays, and notifications.
