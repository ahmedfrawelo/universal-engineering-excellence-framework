...
Measures adoption and quality of the unified design system without hiding critical failures behind averages.

## Required Practice

- Score tokens, color, typography, icons, spacing, sizing, radius, borders, shadows, elevation, motion, components, registry, patterns, layouts, themes, responsive behavior, interactions, overlays, accessibility, performance, and reuse.
- Use zero to four scoring with linked evidence and an owner for gaps.
- Cap the result at fail when critical governance violations remain.
...
- framework/16-design-system/01-consistency-reuse
