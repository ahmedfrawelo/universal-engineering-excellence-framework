...
Defines a layered token model from primitive values to semantic roles to component contracts.

## Required Practice

- Separate primitive, semantic, and component tokens.
- Expose tokens through typed or lintable interfaces where the stack supports it.
- Deprecate tokens with aliases and migration notes instead of silent replacement.
