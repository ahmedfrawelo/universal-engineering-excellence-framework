...
Defines border presence, color, width, focus, divider, and solid-line behavior.

## Required Practice

- Use named none, subtle, default, strong, and focus styles.
- Use semantic border tokens and preserve contrast in every theme.
- Do not introduce dashed or dotted UI borders except when represented content requires the notation.
