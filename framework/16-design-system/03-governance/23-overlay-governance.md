...
Enforces one contract for dropdowns, popovers, panels, drawers, tooltips, menus, dialogs, and modals.

## Required Practice

- Define trigger, outside click, peer conflict, Escape, focus, scroll, collision, portal, and layer behavior.
- Use semantic surface types instead of choosing a modal by convenience.
- Verify same-trigger close, focus restoration, viewport containment, and reduced motion.
