...
Provides a repeatable final review for every UI or design-system change.

## Required Practice

- Verify existing-system inspection, registry search, reuse decision, token mapping, component ownership, theme, responsive, accessibility, interaction, performance, and tests.
- Check all visual values and behavior against approved contracts.
- Record exceptions, migration, screenshots or traces, commands, and residual risk.
