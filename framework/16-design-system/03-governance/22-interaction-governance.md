...
Creates one interaction language for states, feedback, commands, navigation, and recovery.

## Required Practice

- Standardize default, hover, focus, active, selected, disabled, loading, success, warning, and error states.
- Keep keyboard and touch outcomes equivalent.
- Prevent duplicate submission and use shared feedback and recovery patterns.
