...
Detects divergence in tokens, components, patterns, states, and visual language.

## Required Practice

- Audit raw values, duplicate components, copied behavior, inconsistent states, and stale registry entries.
- Use visual regression, lint rules, registry checks, and review evidence where practical.
- Give each drift finding an owner, impact, target, and remediation date.
