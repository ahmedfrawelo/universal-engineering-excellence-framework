...
Defines an approved type scale, roles, weights, line heights, measure, and responsive behavior.

## Required Practice

- Allow only Display, H1-H4, Title, Subtitle, Body Large, Body, Body Small, Caption, Label, Button, and Overline roles unless approved.
- Use tokenized font family, size, weight, line height, and tracking.
- Keep body measure readable and test localization, zoom, and text scaling.
