...
Defines ownership, decision rights, change control, and evidence for one unified product language.

## Required Practice

- Assign owners for tokens, components, patterns, templates, interaction contracts, and migrations.
- Require design-system review for changes that affect more than one feature.
- Version breaking visual or behavioral contracts and publish migration guidance.
