...
Makes reuse, extension, generalization, documentation, and adoption the mandatory path before creation.

## Required Practice

- Search the project, design system, registry, shared components, shared services, and patterns in that order.
- Reuse unchanged when semantics match; extend when the contract remains compatible; generalize only with real consumers.
- Record rejected alternatives and the reason a new capability is necessary.
