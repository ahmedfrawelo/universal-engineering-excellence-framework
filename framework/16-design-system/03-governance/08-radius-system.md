...
Governs soft surfaces and proportional nesting through shared radius roles.

## Required Practice

- Define none, xs, sm, md, lg, xl, and full tokens.
- Assign radius by component role and nesting depth.
- Use full radius only for semantically pill-shaped elements, not every control.
