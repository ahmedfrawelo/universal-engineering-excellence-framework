...
Provides approved templates for recurring product page outcomes.

## Required Practice

- Define list, detail, workflow, dashboard, settings, and access-state templates where evidence supports them.
- Keep templates composable and permission-aware.
- Specify mobile, tablet, desktop, short-height, loading, empty, error, and success states.
