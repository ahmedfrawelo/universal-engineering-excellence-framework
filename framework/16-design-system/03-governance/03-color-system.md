...
Governs semantic color roles across themes, states, data visualization, and accessibility.

## Required Practice

- Use semantic roles such as background, surface, text, border, action, status, focus, scrim, and navigation.
- Map roles independently for light, dark, system, and high-contrast contexts.
- Reject raw feature-level colors and verify contrast for normal, disabled, focus, selected, error, and chart states.
