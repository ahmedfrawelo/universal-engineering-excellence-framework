# Design Governance Quality Gate
...
Blocks design changes that violate token, visual, component, responsive, theme, reuse, accessibility, or interaction governance.
