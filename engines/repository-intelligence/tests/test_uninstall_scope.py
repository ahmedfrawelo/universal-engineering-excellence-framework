...
def _global_dot_dir(platform: str, project_dot_dir: str) -> str:
    """Return the documented user-global destination for this platform."""
    if platform == "gemini" and os.name == "nt":
        return ".agents"
    return project_dot_dir
