...
# A locally installed SDK is not consent to make network connections during the
# default test suite.  This integration is exercised only when a caller has
# explicitly provisioned FalkorDB and opted in.
if os.environ.get("GRAPHIFY_TEST_FALKORDB") != "1":
    pytest.skip("set GRAPHIFY_TEST_FALKORDB=1 to run FalkorDB integration tests", allow_module_level=True)
