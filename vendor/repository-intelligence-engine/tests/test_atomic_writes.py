...
@pytest.mark.skipif(os.name == "nt", reason="Windows does not expose POSIX mode semantics")
...
@pytest.mark.skipif(os.name == "nt", reason="Windows does not expose POSIX umask semantics")
